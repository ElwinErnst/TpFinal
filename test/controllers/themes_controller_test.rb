...
class ThemesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create theme" do
    assert_difference('Theme.count') do
      post themes_url, params: { theme: { category_id: @theme.category_id, description: @theme.description, name: @theme.name } }
    end
  ...
  test "should update theme" do
    patch theme_url(@theme), params: { theme: { category_id: @theme.category_id, description: @theme.description, name: @theme.name } }
